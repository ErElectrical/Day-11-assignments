...
using System.IO;
using System.Text;
namespace ShopInventoryManagement
{
    class InventoryMange
    {
        InventoryFactory iv;
        string FilePath = @"C:\Users\as\Desktop\.net\ShopInventorymanagementsystem\jsonfile.json";
        ...
        {
            Console.WriteLine("welocome to shop inventory managements system ");
            InventoryMange vi = new InventoryMange();
            vi.InventoryManagements();
        }
    }
}
